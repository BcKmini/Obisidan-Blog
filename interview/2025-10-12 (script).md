...
"Good morning, professors. My name is Kyoung Min Kim, and I will be giving the presentation on 'The Core of Multi-class Classification'.

I chose this topic because a solid understanding of the basics is key to my research goals at DGIST. I want to study 'Physical AI', which combines vision, language, and action. All these complex tasks rely on a simple, core idea: classification. This presentation will show that I have the strong foundation needed for my future research."
...
By dividing the top by the bottom, we are essentially calculating 'this class's score' as a 'percentage of the total score'. This is how scores like 2.0, 1.0, and 0.1 become clear probabilities like 66%, 24%, and 10%. Now we know how confident the model is for each class."
...
- The **log** function is a special calculator. When the probability for the correct answer (py​) is high (close to 1), the log value is very small. When the probability is low (close to 0), the log value becomes a large negative number.
